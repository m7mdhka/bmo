...
import type { DatabaseEngineModule, EngineCapabilities, SearchConfig } from "@/components/runtime/databases/types";
...
const definition: EngineDefinition<"Elasticsearch"> = {
  id: "Elasticsearch",
  label: "Elasticsearch",
  group: GROUPS.search,
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Field label="Auth mode">
            <select
              value={c.authMode}
              onChange={(e) =>
                onChange({ ...details, config: { ...c, authMode: e.target.value as SearchConfig["authMode"] } })
              }
...
export const elasticsearch: DatabaseEngineModule<"Elasticsearch"> = {
  id: "Elasticsearch",
  family: FAMILIES.search,
  definition,
  capabilities: JSON_CAPABILITIES,
  studio: {
    queryLabel: "Search Query",
    starterQuery: '{ "operation": "find", "payload": { "index": "users", "query": { "match_all": {} }, "size": 20 } }',
    objectNoun: "index",
  },
