...
import type { DatabaseEngineModule, EngineCapabilities, Neo4jConfig } from "@/components/runtime/databases/types";
...
const definition: EngineDefinition<"Neo4j"> = {
  id: "Neo4j",
  label: "Neo4j",
  group: GROUPS.graph,
...
export const neo4j: DatabaseEngineModule<"Neo4j"> = {
  id: "Neo4j",
  family: FAMILIES.graph,
  definition,
  capabilities: JSON_CAPABILITIES,
  studio: {
    queryLabel: "Cypher Payload",
    starterQuery: '{ "operation": "command", "payload": { "query": "MATCH (n) RETURN n LIMIT 20" } }',
    objectNoun: "node",
  },
