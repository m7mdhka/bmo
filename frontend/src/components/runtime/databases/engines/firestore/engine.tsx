...
import type { DatabaseEngineModule, EngineCapabilities, FirestoreConfig } from "@/components/runtime/databases/types";
...
const definition: EngineDefinition<"Firestore"> = {
  id: "Firestore",
  label: "Firestore",
...
export const firestore: DatabaseEngineModule<"Firestore"> = {
  id: "Firestore",
  ...
  studio: {
    ...
    starterQuery:
      '{ "operation": "find", "payload": { "collection": "users", "where": [{ "field": "active", "op": "==", "value": true }], "limit": 20 } }',
